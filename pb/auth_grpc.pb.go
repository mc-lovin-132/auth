...
const (
	...
	AuthService_Access_FullMethodName  = "/auth.AuthService/Access"
	AuthService_Revoke_FullMethodName  = "/auth.AuthService/Revoke"
)
...
func (c *authServiceClient) Access(ctx context.Context, in *AccessRequest, opts ...grpc.CallOption) (*AccessResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AccessResponse)
	err := c.cc.Invoke(ctx, AuthService_Access_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) Access(context.Context, *AccessRequest) (*AccessResponse, error) {
...
func _AuthService_Access_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AccessRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).Access(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_Access_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).Access(ctx, req.(*AccessRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Access",
			Handler:    _AuthService_Access_Handler,
		},
		{
			MethodName: "Revoke",
...
const (
	HealthService_Health_FullMethodName = "/auth.HealthService/Health"
	HealthService_Ping_FullMethodName   = "/auth.HealthService/Ping"
)
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "auth.HealthService",
